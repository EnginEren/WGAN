...
if __name__=="__main__":
    ...
    if noBN:
        netG = dcgan.DCGAN_G_nobn(imageSize, nc, nz, ngf, ngpu, n_extra_layers)
    elif mlp_G:
        netG = mlp.MLP_G(imageSize, nc, nz, ngf, ngpu)
    else:
        netG = dcgan.DCGAN_G(imageSize, nc, nz, ngf, ngpu, n_extra_layers)
